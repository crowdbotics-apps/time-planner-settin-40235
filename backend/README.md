...
## Project Structure
    ...
    ├── time_planner_settin_40235  # Django project configurations
...
1. Clone this repo and `cd time_planner_settin_40235`
...
2. Clone this repo and `cd time_planner_settin_40235`
